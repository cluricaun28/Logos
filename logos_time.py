"""
Timezone-aware clock for Logos.
...
Invalid timezone values log a warning and fall back safely — Logos never
...
from logos_constants import get_config_path, logos_env
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Logos requires 3.9+)
...
def _resolve_timezone_name() -> str:
    ...
    tz_env = logos_env("TIMEZONE", "").strip()
    if tz_env:
        return tz_env
