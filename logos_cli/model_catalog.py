...
The Logos docs site hosts a JSON manifest of curated models for providers
...
def _cache_path() -> Path:
    ...
    return get_logos_home() / "cache" / "model_catalog.json"
...
def reset_cache() -> None:
    """Clear the in-process cache. Used by tests and ``logos model --refresh``."""
    global _catalog_cache, _catalog_cache_source_mtime
    _catalog_cache = None
