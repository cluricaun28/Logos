...
def _make_voice_cli(**overrides):
    """Create a minimal LogosCLI with only voice-related attrs initialized.
...
class TestDisableVoiceModeStopsTTS:
    ...
    def test_disable_voice_mode_calls_stop_playback(self):
        ...
        source = inspect.getsource(LogosCLI._disable_voice_mode)
...
class TestVoiceBeepConfigReal:
    ...
    @patch("logos_cli.config.load_config", return_value={"voice": {"beep_enabled": False}})
