...
@pytest.mark.asyncio
async def test_first_run_home_channel_onboarding_uses_sethome(monkeypatch):
    import gateway.run as gateway_run
    ...
    assert "to make this chat your home channel" in onboarding
