...
def hermes_home(tmp_path, monkeypatch):
    ...
    if hasattr(logos_constants, "_hermes_home_cache"):
        logos_constants._hermes_home_cache = None
    return home
...
def test_save_conversation_writes_under_hermes_home(hermes_home, tmp_path, monkeypatch, capsys):
    ...
    cli.LogosCLI.save_conversation(stub)
    ...
    assert "logos --resume 20260101_120000_abc123" in out, out
