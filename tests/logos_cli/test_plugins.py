...
class TestPluginHooks:
    ...
    def test_invalid_hook_name_warns(self, tmp_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="logos_cli.plugins"):
            mgr = PluginManager()
            mgr.discover_and_load()
...
class TestPluginCommands:
    ...
    def test_get_plugin_command_handler_found(self):
        ...
        with patch("logos_cli.plugins._plugin_manager", mgr):
    ...
    def test_get_plugin_context_engine_discovers_plugins_lazily(self, tmp_path, monkeypatch):
        ...
        (plugin_dir / "__init__.py").write_text(
            ...
            "        return None\n\n"
            "    def should_archive(self, prompt_tokens):\n"
            "        return False\n\n"
            "    def archive(self, messages, current_tokens):\n"
            "        return messages\n\n"
            "def register(ctx):\n"
...
class TestPluginDispatchTool:
    ...
    def test_dispatch_tool_calls_registry(self):
        ...
        with patch("logos_cli.plugins.PluginContext.dispatch_tool.__module__", "logos_cli.plugins"):
