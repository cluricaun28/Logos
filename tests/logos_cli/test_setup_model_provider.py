...
from logos_cli.main, these tests mock the delegation point and verify
...
from logos_cli.nous_subscription import NousFeatureState, NousSubscriptionFeatures
from logos_cli.setup import _print_setup_summary, setup_model_provider
...
def test_setup_same_provider_rotation_strategy_saved_for_multi_credential_pool(tmp_path, monkeypatch):
    ...
    import logos_cli.setup as _setup_mod
...
def test_setup_same_provider_fallback_can_add_another_credential(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("logos_cli.setup.prompt_yes_no", fake_prompt_yes_no)
    ...
    monkeypatch.setattr("logos_cli.auth_commands.auth_add_command", fake_auth_add_command)
...
def test_setup_summary_shows_camofox_when_browser_feature_is_camofox(tmp_path, monkeypatch, capsys):
    ...
    _clear_provider_env(monkeypatch)
    monkeypatch.setattr(
        "logos_cli.setup.get_nous_subscription_features",
