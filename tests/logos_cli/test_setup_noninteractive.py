...
import pytest
from logos_cli.config import DEFAULT_CONFIG, load_config, save_config
...
class TestNonInteractiveSetup:
    ...
    def test_cmd_setup_allows_noninteractive_flag_without_tty(self):
        ...
        from logos_cli.main import cmd_setup

        args = _make_setup_args(non_interactive=True)

        with (
            patch("logos_cli.setup.run_setup_wizard") as mock_run_setup,
    ...
    def test_main_accepts_tts_setup_section(self, monkeypatch):
        ...
        from logos_cli import main as main_mod
