"""Tests for logos_cli/completion.py — shell completion script generation."""
...
from logos_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
class TestSubcommandDrift:
    def test_SUBCOMMANDS_covers_required_commands(self):
        ...
        """
        import inspect
        from logos_cli.main import _coalesce_session_name_args
