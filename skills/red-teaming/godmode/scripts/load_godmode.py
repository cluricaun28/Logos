...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("LOGOS_HOME") or os.environ.get("HERMES_HOME") or os.path.expanduser("~/.hermes"), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.environ.get("LOGOS_HOME") or os.environ.get("HERMES_HOME") or str(Path.home() / ".hermes")) / "skills" / "red-teaming" / "godmode" / "scripts"
