...
try:
    from logos_constants import display_hermes_home as display_hermes_home
    from logos_constants import get_hermes_home as get_hermes_home
except (ModuleNotFoundError, ImportError):

    def get_hermes_home() -> Path:
        """Return the Logos home directory (default: ~/.hermes).

        Mirrors ``logos_constants.get_hermes_home()``."""
    ...
    def display_hermes_home() -> str:
        ...
        Mirrors ``logos_constants.display_hermes_home()``."""
