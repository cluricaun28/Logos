...
4. Name the token (e.g., "Logos"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.logos/.env` (legacy `~/.hermes/.env`)`:
...
```bash
CANVAS="python $LOGOS_HOME/skills/productivity/canvas/scripts/canvas_api.py"
