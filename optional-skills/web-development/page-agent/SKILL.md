...
- User wants **Logos itself to drive a browser** → use Logos' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
