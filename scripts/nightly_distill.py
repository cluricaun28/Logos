...
LOGOS_DIR = Path.home() / ".hermes"
QUEUE_PATH = LOGOS_DIR / "staging" / "distillation_queue.json"
SCANNER_SCRIPT = LOGOS_DIR / "scripts" / "phase3_signal_scanner.py"
PROJECT_DIR = LOGOS_DIR / "hermes-agent"
