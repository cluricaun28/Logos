"""CLI entry point for the logos-agent ACP adapter.
...
def _load_env() -> None:
    ...
    logos_home = get_logos_home()
    loaded = load_logos_dotenv(logos_home=logos_home)
    if loaded:
...
def main() -> None:
    ...
    logger.info("Starting logos-agent ACP adapter")
