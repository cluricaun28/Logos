...
Lets the LLM write a Python script that calls Logos tools via RPC,
...
"""Auto-generated Logos tools RPC stubs."""
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    When tools are disabled via ``logos tools`` (e.g. web is turned off),
    ...
    description = (
        "Run a Python script that can call Logos tools programmatically. "
