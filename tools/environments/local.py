...
# Logos-internal env vars that should NOT leak into terminal subprocesses.
...
def _build_provider_env_blocklist() -> frozenset:
    ...
    try:
        from logos_cli.config import OPTIONAL_ENV_VARS
...
def _find_bash() -> str:
    ...
    raise RuntimeError(
        "Git Bash not found. Logos requires Git for Windows on Windows.\n"
...
def _resolve_shell_init_files() -> list[str]:
    ...
    an explicit list — once they have, Logos trusts them.
    """
