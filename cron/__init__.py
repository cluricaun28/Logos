"""
Cron job scheduling system for Logos.
...
Cron jobs are executed automatically by the gateway daemon:
    logos gateway install    # Install as a user service
    sudo logos gateway install --system  # Linux servers: boot-time system service
