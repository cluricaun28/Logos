...
Logos does **not** operate a bug bounty program. Security issues should be reported via [GitHub Security Advisories](https://github.com/cluricaun28/Logos/security/advisories/new). Do not open public issues for security vulnerabilities.
